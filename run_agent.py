            ...
            try:
                ...
                if assistant_message.tool_calls:
                    ...
                    if not self._has_content_after_think_block(final_response):
                        ...
                        # ── Empty response treated as normal ────────────
                        # Per user request: if the model returns empty, treat it as normal
                        logger.info("Model returned empty response — treating as normal successful turn per user config")
                        # Let execution fall through to normal turn completion
